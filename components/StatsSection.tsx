...
const StatsSection = () => {
  ...
  return (
    <>
      <div className="p-20 ">
        <div className="relative max-w-8xl h-[400px] lg:h-72 overflow-hidden rounded-[32px]">
          {/* Background Image */}
          <div className="absolute inset-0 z-0">
            ...
            />
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-gradient-to-b from-green-400 to-primary" />
          </div>
