  ...
  return (
    <div className="w-full bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-16">
        {/* Header */}
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-gray-800  mb-16 px-4">
          <span className="text-primary">Esscence</span> Projects
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="relative bg-gray-800 rounded-3xl overflow-hidden p-8 flex flex-col hover:shadow-lg transition-shadow duration-300 min-h-[400px]">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <Link
                href="/services"
                className="inline-flex items-center gap-2 px-6 py-3 bg-primary rounded-full text-white font-semibold hover:bg-primary/90 transition-colors duration-300 self-start cursor-pointer"
              >
                Learn More
                <ArrowRight className="w-5 h-5" />
              </Link>
