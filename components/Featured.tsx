...
const FeaturedProjects = () => {
  ...
  return (
    <div
      className="relative flex flex-col items-center w-full py-20 gap-16 px-4 md:px-8 lg:px-16 bg-primary/90"
      // style={{
                ...
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ease-in-out hover:scale-125 active:scale-90 cursor-pointer ${
                    currentIndex === index
                      ...
                      : isAnimating
                      ? "bg-gray-100/30 cursor-not-allowed"
                      : "bg-gray-100/30 hover:bg-primary/70"
                  }`}
                />
              ))}
            </div>
