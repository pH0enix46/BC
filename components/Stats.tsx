...
export default function Stats() {
  return (
    <div>
      {/* Stats Section */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16 bg-gradient-to-l from-primary/40 to-primary px-3 sm:px-4 py-4 sm:py-6 shadow">
