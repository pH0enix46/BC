    ...
    <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <p
            className="text-primary text-2xl font-medium mb-2"
            data-aos="fade-down"
            data-aos-delay="100"
          >
            Why Choose Us
          ...
          <p
            className="text-primary text-base md:text-lg max-w-3xl mx-auto"
            data-aos="fade-up"
            data-aos-delay="300"
          >
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-primary/20">
                  <Image
