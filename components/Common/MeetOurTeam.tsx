...
const WorkSteps = () => {
  ...
  return (
    <div className="w-full py-16 relative overflow-hidden px-4 md:px-8 lg:px-16 bg-primary/90">
      ...
      <div className="relative">
        ...
        <div className="px-4 w-[97%] mx-auto relative">
          ...
          <button
            ...
            className={`absolute top-1/2 -left-4 sm:-left-8 lg:-left-16 transform -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 hover:bg-primary/90 rounded-full flex items-center justify-center transition-colors bg-primary ${
              isTransitioning
          ...
          <button
            ...
            disabled={isTransitioning}
            className={`absolute top-1/2 -right-4 sm:-right-8 lg:-right-16 transform -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 hover:bg-primary/90 rounded-full flex items-center justify-center transition-colors bg-primary ${
              isTransitioning
                ? "opacity-50 cursor-not-allowed"
                : "cursor-pointer"
            }`}
            ...
            {getCurrentMembers().map((member, index) => (
              ...
              >
                <div className="w-full aspect-[380/420] relative overflow-hidden rounded-lg">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-[#209bd7]/0 to-primary opacity-0 group-hover:opacity-90 transition-opacity duration-300"></div>
